const en = {
  ...
  "announcement.subtitle":
    "Stay up to date with the latest news, events, and updates from the FluxDown team.",
  ...
  "qqGroup.subtitle":
    "Scan the QR code or search the group number to join the FluxDown QQ group and chat with developers and other users.",
  ...
  "vote.subtitle":
    "Help us decide which community platform to create. Your vote shapes the future of FluxDown's community!",
  "vote.wechat": "WeChat Group",
  "vote.wechatDesc":
    "Convenient for daily communication, voice messages, and real-time discussion with the community.",
  "vote.qq": "QQ Group",
  "vote.qqDesc":
    "Rich features with file sharing, screen sharing, and persistent chat history for the community.",
  "vote.officialAccount": "Official Account",
  "vote.officialAccountDesc":
    "Curated updates, feature announcements, tutorials, and polished articles from the team.",
  "vote.votes": "{n} votes",
  ...
  "logoVote.subtitle":
    "Vote for your favorite logo design or submit your own. The community decides the future look of FluxDown!",
  "logoVote.loading": "Loading logos...",
  "logoVote.loadError": "Failed to load logos",
  "logoVote.votes": "{n} votes",
  "logoVote.vote": "Vote",
  "logoVote.unvote": "Unvote",
  "logoVote.voting": "Voting...",
  "logoVote.voteSuccess": "Voted!",
  "logoVote.unvoteSuccess": "Vote removed",
  "logoVote.voteError": "Vote failed, please try again",
  "logoVote.rateLimited": "Too many requests, please wait",
  "logoVote.rank": "#{n}",
  "logoVote.topBadge": "Top 10",
  "logoVote.uploadTitle": "Submit Your Logo",
  "logoVote.uploadDesc":
    "Have a design idea? Upload your logo and let the community vote!",
  "logoVote.dropHint": "Drop image here or click to select",
  "logoVote.dropHintActive": "Release to upload",
  "logoVote.fileLimit": "PNG / JPG / SVG / WebP · Max 2MB",
  "logoVote.nameLabel": "Your Name (optional)",
  "logoVote.namePlaceholder": "Anonymous",
  "logoVote.descLabel": "Description (optional)",
  "logoVote.descPlaceholder": "Describe your design concept...",
  "logoVote.submit": "Submit Logo",
  "logoVote.submitting": "Uploading...",
  "logoVote.submitSuccess": "Logo submitted! It will appear shortly.",
  "logoVote.submitError": "Upload failed, please try again",
  "logoVote.submitRateLimited": "Too many submissions, please wait 24 hours",
  "logoVote.fileTooLarge": "File too large (max 2MB)",
  "logoVote.fileInvalidType": "Invalid file type",
  "logoVote.builtin": "Official",
  "logoVote.community": "Community",
  "logoVote.anonymous": "Anonymous",
  "logoVote.noLogos": "No logos yet. Be the first to submit!",
  "logoVote.uploadedBy": "by {name}",

  // Nav
  "nav.logoVote": "Logo Vote",
  ...
  // Theme Market
  "themes.badge": "Theme Market",
  "themes.title": "Community Themes for FluxDown",
  "themes.subtitle":
    "Browse themes crafted by the community. Download the theme JSON and import it in the desktop app under Settings → Appearance.",
  "themes.searchPlaceholder": "Search themes, authors, tags...",
  "themes.submitCta": "Submit your theme",
  "themes.clickToZoom": "Click to zoom",
  "themes.variant.dark": "Dark",
  "themes.variant.light": "Light",
  "themes.download": "Download Theme",
  "themes.download.dark": "Dark JSON",
  "themes.download.light": "Light JSON",
  "themes.loadError": "Failed to load the theme index. Please try again later or visit the repository directly.",
  "themes.empty": "No themes match your search.",
  "themes.howTo.title": "How to use a theme",
  ...
  "tb.title": "Build FluxDown themes in browser",
  "tb.rightClickHint": "Right-click any UI block to inspect token values",
  "tb.rightClickDesc":
    "Each preview block is bound to token paths. Right-click to open inspector and copy path or value.",
  "tb.meta.name": "Theme Name",
  "tb.meta.author": "Author",
  "tb.appearance.dark": "Dark",
  "tb.appearance.light": "Light",
  "tb.actions.import": "Import",
  "tb.actions.export": "Export",
  "tb.actions.copyJson": "Copy JSON",
  "tb.actions.reset": "Reset",
  "tb.searchPlaceholder": "Search token path or name",
  "tb.groups.surface": "Surface",
  "tb.groups.element": "Element",
  "tb.groups.text": "Text",
  "tb.groups.border": "Border",
  "tb.groups.accent": "Accent",
  "tb.groups.input": "Input",
  "tb.groups.dialog": "Dialog",
  "tb.groups.switch": "Switch",
  "tb.groups.status": "Status",
  "tb.groups.shadow": "Shadow",
  "tb.groups.segment": "Segment Palette",
  "tb.groups.radius": "Radius",
  "tb.groups.spacing": "Spacing",
  "tb.groups.stroke": "Stroke",
  "tb.groups.button": "Button",
  "tb.groups.alpha": "Alpha",
  "tb.groups.mobile": "Mobile Geometry",
  "tb.importSuccess": "Imported theme: {name}",
  "tb.importError": "Import failed: {reason}",
  "tb.exportSuccess": "Exported theme: {name}",
  "tb.copySuccess": "Copied",
  "tb.copyError": "Copy failed",
  "tb.resetSuccess": "Theme reset to default dark",
  "tb.context.title": "Token Inspector",
  "tb.context.copyPath": "Path",
  "tb.context.copyValue": "Value",
  "tb.compat.title": "Desktop-Compatible Schema",
  "tb.compat.desc":
    "JSON follows FluxThemeTokens.toJson()/fromJson() structure (appearance + colors + segmentPalette).",
  "tb.mobileTitle": "Open on desktop",
  "tb.mobileHint": "The theme designer needs a wide screen. Please open this page on a desktop/PC browser to avoid a broken layout.",
  "tb.area.downloads": "Main window",
  "tb.area.settings": "Settings page",
  "tb.areaHint": "Where this token shows up in the preview",
  "tb.viewDownloads": "Main window",
  "tb.viewSettings": "Settings",
  ...
  "hero.stat2.label": "Ads & Tracking",
  "hero.stat3.value": "100%",
  "hero.stat3.label": "Free Forever",
  ...
  "mockup.settingsGeneral": "General",
  "mockup.settingsAppearance": "Appearance",
  "mockup.settingsDownload": "Download",
  "mockup.settingsLanguage": "Language",
  "mockup.settingsBack": "Back",
  "mockup.settingsThemeSelect": "Theme",
  "mockup.settingsThemeSelectHint": "Pick a preset or import your own",
  "mockup.settingsThemeName": "Theme {n}",
  "mockup.settingsColorScheme": "Accent Color",
  "mockup.settingsDownloadHint": "Default save location and actions",
  "mockup.settingsSelectionSample": "selected text sample",
  "mockup.settingsBtnSmall": "Small",
  "mockup.settingsBtnMedium": "Save",
  "mockup.settingsBtnLarge": "Apply",
  "mockup.settingsMisc": "Behavior",
  "mockup.settingsSwitchOn": "Close to tray",
  "mockup.settingsSwitchOff": "Auto start (disabled)",
  "mockup.settingsGlassPanel": "Glass panel",
  "mockup.settingsGlassSubtle": "Subtle glass",
  "mockup.settingsScrim": "Dialog overlay",
  "mockup.settingsStates": "States & Dialog",
  "mockup.settingsStateHover": "Hover",
  "mockup.settingsStateBadge": "Badge",
  "mockup.settingsStateDisabled": "Disabled",
  "mockup.settingsStateFocused": "focused input",
  "mockup.settingsStateDialog": "Dialog background sample",
  ...
  "features.subtitle":
    "A powerful download manager built with modern technologies to deliver exceptional performance and reliability.",
  ...
  "features.protoDesc":
    "HTTP, HTTPS, FTP, BitTorrent with magnet link support, and HLS/DASH streaming. Each protocol has a dedicated, optimized engine — from HTTP Range requests to DHT peer discovery.",
  ...
  "features.uiTitle": "Beautiful Interface",
  "features.uiDesc":
  ...
  "features.cleanTitle": "Clean & Private",
  "features.cleanDesc":
  ...
  "ext.feat2.desc":
    "Secure localhost:19527 HTTP endpoint — no cloud, no tracking, all data stays local",
  ...
  "dl.linux": "Linux",
  "dl.web": "Web",
  "dl.webArch": "Self-hosted · browser access",
  "dl.webGuide": "View Setup Guide",
  "dl.cli": "CLI",
  "dl.cliArch": "Command line · aria2-style",
  ...
  "fb.subtitle":
    "Have a feature idea or found a bug? We'd love to hear from you. Your feedback helps shape the future of FluxDown.",
  ...
  "fbList.subtitle":
    "Track the progress of feature requests, bug reports, and suggestions from the community.",
  ...
  "issueDetail.viewOnGithub": "View on GitHub",
  ...
  "faq.items.0.a":
    "Yes, FluxDown is completely free with no ads, no subscriptions, and no hidden fees. All features are available to every user.",
  ...
  "faq.items.4.a":
    "FluxDown offers similar multi-threaded download acceleration but is completely free and built with modern technology (Rust + Flutter). It supports HTTP, HTTPS, FTP, BitTorrent, and HLS/DASH streaming, features smart segmentation based on your system specs, and provides a native desktop experience.",
  ...
  "changelog.downloadAssets": "Download this version",
  "changelog.assetsNote":
    "Downloads are proxied through our server. Files are sourced directly from GitHub Releases.",
  ...
  "privacy.s1.item1":
    "Website analytics: We use Vercel Web Analytics, a privacy-friendly analytics service that collects anonymous, aggregated page view data. No cookies are used, no personal data is collected, and no individual users are tracked.",
  "privacy.s1.item2":
    "Feedback submissions: When you voluntarily submit feedback through our website, we collect the feedback type, title, description, and optionally your contact information. This data is stored as GitHub Issues in our repository.",
  "privacy.s1.item3":
    "Email subscriptions: If you subscribe to platform availability notifications, we store your email address in a GitHub Issue. This is used solely to notify you when the requested platform becomes available.",

  "privacy.s2.title": "2. Information We Do NOT Collect",
  "privacy.s2.desc":
    "FluxDown is designed with a local-first architecture. The desktop application:",
  "privacy.s2.item1":
  ...
  "privacy.s2.item2":
    "Does NOT include any telemetry, crash reporting, or usage analytics in the desktop application.",
  "privacy.s2.item3":
    "Does NOT require an account, login, or registration of any kind.",
  "privacy.s2.item4":
    "Does NOT communicate with any external server. The application operates entirely offline after installation.",

  "privacy.s3.title": "3. Browser Extension",
  "privacy.s3.desc":
    "The FluxDown browser extension communicates exclusively with the FluxDown desktop application via a local HTTP endpoint (localhost:19527). Specifically:",
  "privacy.s3.item1":
  ...
  "privacy.s3.item2":
    "The extension stores your preferences (auto-intercept toggle, file type filters, domain rules) in your browser's local storage (chrome.storage.sync/local). This data syncs only through your browser's built-in sync mechanism, if enabled.",
  "privacy.s3.item3":
  ...
  "privacy.s4.desc":
    "This website uses Vercel Web Analytics, which is a privacy-focused analytics service. It does not use cookies, does not collect personal information, does not track individual users across sessions, and is compliant with GDPR, CCPA, and other privacy regulations without requiring a cookie consent banner.",

  "privacy.s5.title": "5. Data Storage & Security",
  "privacy.s5.desc":
    "All download data (task records, file paths, progress) is stored locally on your device in a SQLite database managed by the FluxDown application. We have no access to this data. Website feedback and subscription data is stored in GitHub Issues within our repository, subject to GitHub's privacy policy.",

  "privacy.s6.title": "6. Third-Party Services",
  "privacy.s6.desc":
    "Our website interacts with the following third-party services:",
  "privacy.s6.item1":
    "GitHub API: Used server-side to fetch release information and process feedback submissions. Your IP address is not forwarded to GitHub.",
  "privacy.s6.item2":
    "Google Fonts: Used to load the Inter font family. Subject to Google's privacy policy.",

  "privacy.s7.title": "7. Children's Privacy",
  "privacy.s7.desc":
    "FluxDown does not knowingly collect any personal information from children under the age of 13. Since the desktop application collects no personal data at all, and website data collection is limited to voluntary feedback submissions, we believe our service is inherently safe for users of all ages.",
  ...
  "privacy.s9.desc":
    "If you have any questions about this Privacy Policy, please reach out to us through the Feedback page on our website.",
  ...
  "terms.s1.desc":
    "By downloading, installing, or using FluxDown, you agree to these Terms. If you do not agree, please do not use the Service. We reserve the right to update these Terms at any time, and continued use constitutes acceptance of any changes.",

  "terms.s2.title": "2. License",
  "terms.s2.desc":
    "FluxDown is provided as free software. Subject to these Terms, we grant you a non-exclusive, non-transferable, revocable license to use the software for personal or commercial purposes. You may:",
  "terms.s2.item1":
  ...
  "terms.s3.desc":
    "You agree to use FluxDown only for lawful purposes. You must NOT use the Service to:",
  "terms.s3.item1":
  ...
  "terms.s4.desc":
    "The FluxDown name, logo, and associated branding are the intellectual property of the FluxDown project. The software's source code is subject to its respective license terms. All content on this website, including text, graphics, and design, is owned by FluxDown unless otherwise noted.",

  "terms.s5.title": "5. Disclaimer of Warranties",
  "terms.s5.desc":
    'FluxDown is provided "AS IS" and "AS AVAILABLE" without warranties of any kind, either express or implied, including but not limited to implied warranties of merchantability, fitness for a particular purpose, and non-infringement. We do not warrant that the Service will be uninterrupted, error-free, or free of harmful components.',

  "terms.s6.title": "6. Limitation of Liability",
  "terms.s6.desc":
    "To the maximum extent permitted by applicable law, FluxDown and its contributors shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of the Service.",

  "terms.s7.title": "7. User Content & Feedback",
  "terms.s7.desc":
    "When you submit feedback, bug reports, or feature requests through our website, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, and display such content for the purpose of improving FluxDown. We will not share your contact information with third parties.",

  "terms.s8.title": "8. Termination",
  "terms.s8.desc":
    "You may stop using FluxDown at any time by uninstalling the software and removing the browser extension. We reserve the right to modify or discontinue the Service at any time without prior notice. Upon termination, all provisions of these Terms that by their nature should survive will remain in effect.",

  "terms.s9.title": "9. Changes to These Terms",
  "terms.s9.desc":
    "We reserve the right to modify these Terms at any time. Updated Terms will be posted on this page with a revised date. Your continued use of the Service after any changes indicates your acceptance of the new Terms.",

  "terms.s10.title": "10. Contact Us",
  "terms.s10.desc":
    "If you have any questions about these Terms of Service, please reach out to us through the Feedback page on our website.",

  // Footer
  "footer.desc":
    "Download manager engineered with Rust. HTTP, FTP, and BitTorrent multi-protocol acceleration, smart segmentation, and seamless browser integration — blazing fast, zero ads, free forever.",
  ...
  "footer.themeBuilder": "Theme Builder",
  "footer.legal": "Legal",
