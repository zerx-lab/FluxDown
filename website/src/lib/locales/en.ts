const en = {
  ...
  "hero.subtitle": "A Rust-powered download manager with HTTP, FTP, and BitTorrent support. Smart multi-threaded acceleration, seamless browser integration, beautiful interface — free forever, zero ads.",
  ...
  "features.protoDesc": "HTTP, HTTPS, FTP and BitTorrent with magnet link support. Each protocol has a dedicated, optimized engine — from HTTP Range requests to DHT peer discovery.",
  ...
  "features.browserDesc": "Chrome/Firefox extension with three-layer interception engine. Auto-detects streaming media (HLS/DASH), smart file type filters, one-click acceleration.",
  "features.uiTitle": "Beautiful Interface",
  "features.uiDesc": "Crafted with care — dark and light themes, 12 color schemes, responsive layout with resizable panels. A download manager that's actually pleasing to use.",
