...
const en = {
  ...
  'set.general.segments': 'Default threads',
  'set.general.segmentsDesc': '0 = decided dynamically by segment_advisor per file size',
...
const zh: Record<I18nKey, string> = {
  ...
  'set.general.segments': '默认下载线程数',
  'set.general.segmentsDesc': '0 = 由 segment_advisor 按文件大小动态决定',
